...
var _View_IonicApp0 = (function (_super) {
    ...
    _View_IonicApp0.prototype.createInternal = function (rootSelector) {
        ...
        this._viewQuery_overlayPortal_1 = new import15.QueryList();
        this._viewQuery_loadingPortal_2 = new import15.QueryList();
        this._viewQuery_toastPortal_3 = new import15.QueryList();
...
export function viewFactory_IonicApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_IonicApp === null)) {
        (renderType_IonicApp = viewUtils.createRenderComponentType('/Users/Perkka/booster/node_modules/ionic-angular/components/app/app-root.d.ts class IonicApp - inline template', 0, import13.ViewEncapsulation.None, styles_IonicApp, {}));
    }

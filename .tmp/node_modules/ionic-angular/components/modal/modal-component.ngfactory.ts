...
class _View_ModalCmp0 extends import1.AppView<import3.ModalCmp> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Backdrop_0_3 = new import14.Backdrop(this.parentInjector.get(import15.GestureController),new import16.ElementRef(this._el_0));
...
export function viewFactory_ModalCmp0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.ModalCmp> {
  if ((renderType_ModalCmp === (null as any))) { (renderType_ModalCmp = viewUtils.createRenderComponentType('/Users/Perkka/booster/node_modules/ionic-angular/components/modal/modal-component.d.ts class ModalCmp - inline template',0,import11.ViewEncapsulation.None,styles_ModalCmp,{})); }

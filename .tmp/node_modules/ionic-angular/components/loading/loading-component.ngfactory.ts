...
class _View_LoadingCmp0 extends import1.AppView<import3.LoadingCmp> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Backdrop_0_3 = new import14.Backdrop(this.parentInjector.get(import16.GestureController),new import10.ElementRef(this._el_0));
...
export function viewFactory_LoadingCmp0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.LoadingCmp> {
  if ((renderType_LoadingCmp === (null as any))) { (renderType_LoadingCmp = viewUtils.createRenderComponentType('/Users/Perkka/booster/node_modules/ionic-angular/components/loading/loading-component.d.ts class LoadingCmp - inline template',0,import12.ViewEncapsulation.None,styles_LoadingCmp,{})); }

...
class _View_Toggle_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Toggle_0_4 = new import3.Toggle(this.parentInjector.get(import8.Form),this.parentInjector.get(import9.Config),new import10.ElementRef(this._el_0),this.renderer,this.parentInjector.get(import11.Item,(null as any)));
...
function viewFactory_Toggle_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_Toggle_Host === (null as any))) { (renderType_Toggle_Host = viewUtils.createRenderComponentType('',0,import13.ViewEncapsulation.None,[],{})); }
  return new _View_Toggle_Host0(viewUtils,parentInjector,declarationEl);
}
export const ToggleNgFactory:import14.ComponentFactory<import3.Toggle> = new import14.ComponentFactory<import3.Toggle>('ion-toggle',viewFactory_Toggle_Host0,import3.Toggle);
...
class _View_Toggle0 extends import1.AppView<import3.Toggle> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Button_2_4 = new import15.Button((null as any),'item-cover',this.parentInjector.get(import9.Config),new import10.ElementRef(this._el_2),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import15.Button) && (2 === requestNodeIndex))) { return this._Button_2_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.detectContentChildrenChanges(throwOnChange);
...
export function viewFactory_Toggle0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Toggle> {
  if ((renderType_Toggle === (null as any))) { (renderType_Toggle = viewUtils.createRenderComponentType('/Users/Perkka/booster/node_modules/ionic-angular/components/toggle/toggle.d.ts class Toggle - inline template',0,import13.ViewEncapsulation.None,styles_Toggle,{})); }

...
class _View_AlertCmp0 extends import1.AppView<import3.AlertCmp> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Backdrop_0_3 = new import14.Backdrop(this.parentInjector.get(import18.GestureController),new import9.ElementRef(this._el_0));
...
export function viewFactory_AlertCmp0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.AlertCmp> {
  if ((renderType_AlertCmp === (null as any))) { (renderType_AlertCmp = viewUtils.createRenderComponentType('/Users/Perkka/booster/node_modules/ionic-angular/components/alert/alert-component.d.ts class AlertCmp - inline template',0,import12.ViewEncapsulation.None,styles_AlertCmp,{})); }

...
export const MenuNgFactory:import16.ComponentFactory<import3.Menu> = new import16.ComponentFactory<import3.Menu>('ion-menu',viewFactory_Menu_Host0,import3.Menu);
...
class _View_Menu0 extends import1.AppView<import3.Menu> {
  _viewQuery_Backdrop_0:import17.QueryList<any>;
  _el_0:any;
  _el_1:any;
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._viewQuery_Backdrop_0 = new import17.QueryList<any>();
    ...
    this._Backdrop_1_3 = new import18.Backdrop(this.parentInjector.get(import14.GestureController),new import9.ElementRef(this._el_1));
...
export function viewFactory_Menu0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Menu> {
  if ((renderType_Menu === (null as any))) { (renderType_Menu = viewUtils.createRenderComponentType('/Users/Perkka/booster/node_modules/ionic-angular/components/menu/menu.d.ts class Menu - inline template',1,import15.ViewEncapsulation.None,styles_Menu,{})); }

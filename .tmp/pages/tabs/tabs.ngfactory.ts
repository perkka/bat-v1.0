...
class _View_TabsPage0 extends import1.AppView<import3.TabsPage> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_4,'tabTitle','Explore');
    ...
    this.renderer.setElementAttribute(this._el_6,'tabIcon','shirt');
    this.renderer.setElementAttribute(this._el_6,'tabTitle','Workout');
    ...
    this.renderer.setElementAttribute(this._el_8,'tabIcon','search');
    this.renderer.setElementAttribute(this._el_8,'tabTitle','Search');
    ...
    this.renderer.setElementAttribute(this._el_10,'tabTitle','Profile');
    this._appEl_10 = new import2.AppElement(10,0,this,this._el_10);
    var compView_10:any = import20.viewFactory_Tab0(this.viewUtils,this.injector(10),this._appEl_10);
    this._Tab_10_4 = new import11.Tab(this._Tabs_0_4,this.parentInjector.get(import15.App),this.parentInjector.get(import16.Config),this.parentInjector.get(import21.Keyboard),new import17.ElementRef(this._el_10),this.parentInjector.get(import22.NgZone),this.renderer,this.parentInjector.get(import23.ComponentFactoryResolver),compView_10.ref,this.parentInjector.get(import24.GestureController),this.parentInjector.get(import25.TransitionController),this.parentInjector.get(import19.DeepLinker,(null as any)));
    this._appEl_10.initComponent(this._Tab_10_4,[],compView_10);
    compView_10.create(this._Tab_10_4,[],(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import11.Tab) && (10 === requestNodeIndex))) { return this._Tab_10_4; }
    if (((token === import10.Tabs) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 11)))) { return this._Tabs_0_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_6:any = 'Explore';
    if (import4.checkBinding(throwOnChange,this._expr_6,currVal_6)) {
      this._Tab_4_4.tabTitle = currVal_6;
      this._expr_6 = currVal_6;
    }
    const currVal_7:any = 'list-box';
    ...
    const currVal_11:any = 'Workout';
    if (import4.checkBinding(throwOnChange,this._expr_11,currVal_11)) {
      this._Tab_6_4.tabTitle = currVal_11;
      this._expr_11 = currVal_11;
    }
    const currVal_12:any = 'shirt';
    ...
    if (import4.checkBinding(throwOnChange,this._expr_15,currVal_15)) {
      this._Tab_8_4.root = currVal_15;
      this._expr_15 = currVal_15;
    }
    const currVal_16:any = 'Search';
    if (import4.checkBinding(throwOnChange,this._expr_16,currVal_16)) {
      this._Tab_8_4.tabTitle = currVal_16;
      this._expr_16 = currVal_16;
    }
    const currVal_17:any = 'search';
    if (import4.checkBinding(throwOnChange,this._expr_17,currVal_17)) {
      this._Tab_8_4.tabIcon = currVal_17;
      this._expr_17 = currVal_17;
    }
    if (((this.numberOfChecks === 0) && !throwOnChange)) { this._Tab_8_4.ngOnInit(); }
    const currVal_20:any = this.context.tab5Root;
    if (import4.checkBinding(throwOnChange,this._expr_20,currVal_20)) {
      this._Tab_10_4.root = currVal_20;
      this._expr_20 = currVal_20;
    }
    const currVal_21:any = 'Profile';
    if (import4.checkBinding(throwOnChange,this._expr_21,currVal_21)) {
      this._Tab_10_4.tabTitle = currVal_21;
      this._expr_21 = currVal_21;
    }
    const currVal_22:any = 'person';
    if (import4.checkBinding(throwOnChange,this._expr_22,currVal_22)) {
      this._Tab_10_4.tabIcon = currVal_22;
    ...
    const currVal_23:any = this._Tab_10_4._tabId;
    if (import4.checkBinding(throwOnChange,this._expr_23,currVal_23)) {
      this.renderer.setElementAttribute(this._el_10,'id',((currVal_23 == (null as any))? (null as any): currVal_23.toString()));
      this._expr_23 = currVal_23;
    }
    const currVal_24:any = this._Tab_10_4._btnId;
    if (import4.checkBinding(throwOnChange,this._expr_24,currVal_24)) {
      this.renderer.setElementAttribute(this._el_10,'aria-labelledby',((currVal_24 == (null as any))? (null as any): currVal_24.toString()));
...
export function viewFactory_TabsPage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.TabsPage> {
  if ((renderType_TabsPage === (null as any))) { (renderType_TabsPage = viewUtils.createRenderComponentType('/Users/Perkka/booster/.tmp/pages/tabs/tabs.html',0,import8.ViewEncapsulation.None,styles_TabsPage,{})); }

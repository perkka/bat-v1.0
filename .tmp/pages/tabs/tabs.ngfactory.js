...
var _View_TabsPage0 = (function (_super) {
    ...
    _View_TabsPage0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_10 = import20.viewFactory_Tab0(this.viewUtils, this.injector(10), this._appEl_10);
        this._Tab_10_4 = new import11.Tab(this._Tabs_0_4, this.parentInjector.get(import15.App), this.parentInjector.get(import16.Config), this.parentInjector.get(import21.Keyboard), new import17.ElementRef(this._el_10), this.parentInjector.get(import22.NgZone), this.renderer, this.parentInjector.get(import23.ComponentFactoryResolver), compView_10.ref, this.parentInjector.get(import24.GestureController), this.parentInjector.get(import25.TransitionController), this.parentInjector.get(import19.DeepLinker, null));
    ...
    _View_TabsPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import11.Tab) && (8 === requestNodeIndex))) {
            return this._Tab_8_4;
        }
        if (((token === import11.Tab) && (10 === requestNodeIndex))) {
            return this._Tab_10_4;
        }
        if (((token === import10.Tabs) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 11)))) {
    ...
    _View_TabsPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_18 = this._Tab_8_4._tabId;
        if (import4.checkBinding(throwOnChange, this._expr_18, currVal_18)) {
            this.renderer.setElementAttribute(this._el_8, 'id', ((currVal_18 == null) ? null : currVal_18.toString()));
            this._expr_18 = currVal_18;
        }
        var currVal_19 = this._Tab_8_4._btnId;
        if (import4.checkBinding(throwOnChange, this._expr_19, currVal_19)) {
            this.renderer.setElementAttribute(this._el_8, 'aria-labelledby', ((currVal_19 == null) ? null : currVal_19.toString()));
            this._expr_19 = currVal_19;
        }
        var currVal_23 = this._Tab_10_4._tabId;
        if (import4.checkBinding(throwOnChange, this._expr_23, currVal_23)) {
            this.renderer.setElementAttribute(this._el_10, 'id', ((currVal_23 == null) ? null : currVal_23.toString()));
            this._expr_23 = currVal_23;
        }
        var currVal_24 = this._Tab_10_4._btnId;
        if (import4.checkBinding(throwOnChange, this._expr_24, currVal_24)) {
            this.renderer.setElementAttribute(this._el_10, 'aria-labelledby', ((currVal_24 == null) ? null : currVal_24.toString()));
...
export function viewFactory_TabsPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_TabsPage === null)) {
        (renderType_TabsPage = viewUtils.createRenderComponentType('/Users/Perkka/booster/.tmp/pages/tabs/tabs.html', 0, import8.ViewEncapsulation.None, styles_TabsPage, {}));
    }

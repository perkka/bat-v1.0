...
export var AboutPageNgFactory = new import10.ComponentFactory('page-contact', viewFactory_AboutPage_Host0, import3.AboutPage);
...
export function viewFactory_AboutPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AboutPage === null)) {
        (renderType_AboutPage = viewUtils.createRenderComponentType('/Users/Perkka/booster/.tmp/pages/about/about.html', 0, import9.ViewEncapsulation.None, styles_AboutPage, {}));
    }

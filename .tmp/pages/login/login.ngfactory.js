...
export var LoginPageNgFactory = new import10.ComponentFactory('ng-component', viewFactory_LoginPage_Host0, import3.LoginPage);
...
var _View_LoginPage0 = (function (_super) {
    ...
    _View_LoginPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_12 = this.renderer.createText(this._el_11, 'LOGIN!', null);
    ...
    _View_LoginPage0.prototype._handle_click_14_0 = function ($event) {
...
export function viewFactory_LoginPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_LoginPage === null)) {
        (renderType_LoginPage = viewUtils.createRenderComponentType('/Users/Perkka/booster/.tmp/pages/login/login.html', 0, import9.ViewEncapsulation.None, styles_LoginPage, {}));
    }

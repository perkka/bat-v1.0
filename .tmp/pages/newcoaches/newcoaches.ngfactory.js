...
var renderType_NewcoachesPage_Host = null;
var _View_NewcoachesPage_Host0 = (function (_super) {
    __extends(_View_NewcoachesPage_Host0, _super);
    function _View_NewcoachesPage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_NewcoachesPage_Host0, renderType_NewcoachesPage_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_NewcoachesPage_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('ng-component', rootSelector, null);
        this._appEl_0 = new import2.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_NewcoachesPage0(this.viewUtils, this.injector(0), this._appEl_0);
        ...
        compView_0.create(this._NewcoachesPage_0_4, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_NewcoachesPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.NewcoachesPage) && (0 === requestNodeIndex))) {
            return this._NewcoachesPage_0_4;
        }
        return notFoundResult;
    };
    return _View_NewcoachesPage_Host0;
}(import1.AppView));
function viewFactory_NewcoachesPage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_NewcoachesPage_Host === null)) {
        (renderType_NewcoachesPage_Host = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, [], {}));
    }
    return new _View_NewcoachesPage_Host0(viewUtils, parentInjector, declarationEl);
}
export var NewcoachesPageNgFactory = new import10.ComponentFactory('ng-component', viewFactory_NewcoachesPage_Host0, import3.NewcoachesPage);
var styles_NewcoachesPage = [];
var renderType_NewcoachesPage = null;
var _View_NewcoachesPage0 = (function (_super) {
    __extends(_View_NewcoachesPage0, _super);
    function _View_NewcoachesPage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_NewcoachesPage0, renderType_NewcoachesPage, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_NewcoachesPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_6 = this.renderer.createText(null, 'Nya Tränare', null);
        ...
        this._text_13 = this.renderer.createText(this._el_12, 'Under uppbyggnad!', null);
        this._text_14 = this.renderer.createText(null, '\n  ', null);
        this._el_15 = this.renderer.createElement(null, 'p', null);
        this._text_16 = this.renderer.createText(this._el_15, 'finns inga nya tränare just ny', null);
    ...
    _View_NewcoachesPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import14.Content) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 17)))) {
            return this._Content_10_4;
        }
        return notFoundResult;
    };
    _View_NewcoachesPage0.prototype.detectChangesInternal = function (throwOnChange) {
    ...
    _View_NewcoachesPage0.prototype.destroyInternal = function () {
        this._Content_10_4.ngOnDestroy();
    };
    return _View_NewcoachesPage0;
}(import1.AppView));
export function viewFactory_NewcoachesPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_NewcoachesPage === null)) {
        (renderType_NewcoachesPage = viewUtils.createRenderComponentType('/Users/Perkka/booster/.tmp/pages/newcoaches/newcoaches.html', 0, import9.ViewEncapsulation.None, styles_NewcoachesPage, {}));
    }
